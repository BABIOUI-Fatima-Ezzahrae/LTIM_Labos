...
$sql = "SELECT * FROM professeur WHERE id_équipe = (SELECT id_équipe FROM professeur WHERE id_encadrent = $idProf)";
...
<div id="passwordForm" style="display: none;">
    ...
    <form action="modifier__Prof.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="idProf" value="<?php echo $row['id_encadrent']; ?>">
