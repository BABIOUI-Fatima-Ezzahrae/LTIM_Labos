...
?>
    ...
    <form action="addDoctorant.php" method="post" enctype="multipart/form-data">
  ...
  <input type="date" name="date_inscription" id="date_inscription" required><br>
  ...
  <textarea name="nom_axe" id="thème" ></textarea><br>
  <input type="hidden" name="id_encadrent" value="<?php echo $idResponsable; ?>" readonly><br>

  <input type="submit" value="Enregistrer">
</form>

</div>
    <!-- ajouter un professeur End -->
    <h1><br><br><br></h1>
<!-- Footer Start -->
<footer>
    <!-- Widgets Start -->
