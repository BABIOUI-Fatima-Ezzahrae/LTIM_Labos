...
if (mysqli_num_rows($resultatsql) > 0) {
    ...
    <div class="title text-center">
        ...
        <a data-aos="fade-right" data-aos-delay="900" href="add_prof.php" class="btn btn-primary">ADD Prof</a>
        </div>
        <div style="margin-right: 30px;">
    ...
    <div>
        ...
        if (isset($_POST['idprof'])) {
            ...
            $idProf = $_POST['idprof'];
            $sql = "SELECT pr.id_encadrent, pr.nom, pr.prenom, pr.id_équipe, r.role
                    FROM professeur pr
                    INNER JOIN roles r ON pr.id_encadrent = r.id_encadrent
                    WHERE pr.id_équipe = $idEquipe AND pr.id_encadrent = $idProf AND pr.id_encadrent != $idResponsable";
            ...
            $sql = "SELECT pr.id_encadrent, pr.nom, pr.prenom, pr.id_équipe, r.role
                    FROM professeur pr
                    INNER JOIN roles r ON pr.id_encadrent = r.id_encadrent
                    WHERE pr.id_équipe = $idEquipe AND pr.nom = '$nomProf' AND pr.id_encadrent != $idResponsable";
                    $result = mysqli_query($connexion, $sql);
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        FROM professeur pr
                        INNER JOIN roles r ON pr.id_encadrent = r.id_encadrent
                        WHERE pr.id_équipe = $idEquipe AND pr.id_encadrent != $idResponsable";
                        $result = mysqli_query($connexion, $sql);
    ...
    <div class="title text-center">
        ...
        <div>
         <!-- Formulaire pour sélectionner l'année/Nom add -->
        <div style="display: flex; justify-content: center; align-items: center;">
            <div style="margin-right: 30px;">
